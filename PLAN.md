...
- [x] 2026-03-17: Fixed a rendering and layout bug where the label filter button was duplicated during UI alignment in `apps/web/core/components/cycles/kpi/page-shell.tsx`, and added the same explicit ChevronDown icon to the label button so both filters match perfectly. Touched files: `apps/web/core/components/cycles/kpi/page-shell.tsx`, `PLAN.md`.
...
- [x] 2026-03-17: `pnpm --filter web exec eslint "core/components/cycles/kpi/page-shell.tsx"` passed after fixing the duplicate label filter and adding the chevron icon.
- [x] 2026-03-17: `pnpm --filter web check:types` passed after fixing the duplicate label filter and adding the chevron icon.
