...
- [x] 2026-03-17: `pnpm --filter web exec eslint "core/components/cycles/kpi/page-shell.tsx"` passed after aligning filter button heights.
- [x] 2026-03-17: `pnpm --filter web check:types` passed after aligning filter button heights.
